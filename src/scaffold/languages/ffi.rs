...
"#,
        ...
        assert!(
            ...
            "expected exactly one blank line between [lints.rust] and [lints.clippy], and the configured \
             print_stdout to merge with the builtin dbg_macro/print_stderr defaults, got:\n{cargo}"
        );
        assert!(
