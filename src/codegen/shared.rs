...
mod tests {
    ...
    fn wasm_constructor_recovers_private_serde_default_via_deserialize() {
        ...
        let typ = owning_type("sample_crate::ExtractionConfig", "ExtractionConfig", vec![field.clone()]);
    ...
    fn wasm_constructor_appends_into_for_named_field_default() {
        let field = FieldDef {
            ...
            typed_default: Some(DefaultValue::FunctionCall("default_sample_crate_crawl_config".to_string())),
            ..Default::default()
        };
        let typ = owning_type("sample_crate::ExtractionConfig", "ExtractionConfig", vec![field.clone()]);
    ...
    fn config_constructor_parts_bare_zero_arg_default_drops_redundant_closure() {
        ...
        assert!(
            assignments
                .contains("max_archive_depth.unwrap_or_else(sample_crate::ExtractionConfig::default_archive_depth)"),
