...
pub use generate::{
    WriteReport, collect_alef_headered_paths, diff_files, finalize_hashes, finalize_hashes_sweeping,
    find_create_once_template_drift, generate, generate_public_api, generate_service_api, generate_stubs,
    generate_sweep_roots, managed_generated_files, managed_output_paths, normalize_content, readme,
