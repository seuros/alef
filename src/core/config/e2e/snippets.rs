...
pub struct SnippetConfig {
    ...
    /// Glob patterns (relative to [`Self::output`]) naming hand-authored snippet files that
    /// are curated on purpose, rather than generated by alef.
    ///
    ...
    /// under `output` at generation time -- a pattern matching zero files fails the run
