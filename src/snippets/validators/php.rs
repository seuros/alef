...
mod tests {
    ...
    fn achievable_level_caps_typecheck_to_syntax() {
        ...
        assert_eq!(PhpValidator.achievable_level(ValidationLevel::Compile), ValidationLevel::Run);
        assert_eq!(PhpValidator.achievable_level(ValidationLevel::Syntax), ValidationLevel::Run);
        assert_eq!(PhpValidator.achievable_level(ValidationLevel::Run), ValidationLevel::Run);
    }
