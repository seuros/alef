...
//!
//! Four backends implement this decision independently: Kotlin and Kotlin Android both emit
...
//! module initializer instead of a build-file setting. Gradle DSL, Maven XML, and "chdir at
//! runtime in the emitted binary" are different enough mechanisms that a single shared
//! Rust/template helper spanning all of them does not fit -- see CLAUDE.md's
